...
public class LeaveBalancePanel extends JPanel {
    ...
    private void loadData() {
        ...
        try {
            ...
            // Check total active employees to provide context for '0' results
            ...
            // Show 'Balances Found / Total Active'
            lblEmpCount.setText(String.format("%d / %d", empsWithBalance.size(), totalActive));
            ...
            // If no balances found but employees exist, prompt the user to Credit Leaves
            if (rows.isEmpty() && totalActive > 0) {
                UIHelper.showInfo(this, "No leave balances found for year " + year + ".\n\n" +
                    "Action Required: Use the '+ Credit Leaves' button to initialize the quota for your " + totalActive + " active employees.");
            }

...
public class ShiftPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        editBtn.addActionListener(e -> {
            ...
            if (id == null) { UIHelper.showInfo(this, "Select a shift first."); return; }
            openForm((int) id);
        });
    ...
    private void openForm(int id) {
        ...
        save.addActionListener(e -> {
            try {
                ...
                dlg.dispose();
                loadData();
            } catch (Exception ex) { UIHelper.showError(dlg, "Validation Error: " + ex.getMessage()); }
        });
    ...
    private void deleteSelected() {
        ...
        if (idVal == null) { UIHelper.showInfo(this, "Select a shift record first."); return; }
        
        int id = (int) idVal;
        if (!UIHelper.confirm(this, "Confirm Action", "Delete this shift schedule permanently?")) return;
        try {

 ...
 * Handles creation, password resets, and status toggling of administrative
 * users.
 */
public class UserManagementPanel extends JPanel {
    ...
    private void openAddUser() {
        ...
        Object[][] rows = { { "Username", uname }, { "Password", pass }, { "System Role", role },
                { "Employee ID", empId } };
        for (Object[] row : rows) {
        ...
        save.addActionListener(e -> {
            try {
                ...
                if (u.isEmpty()) {
                    UIHelper.showWarning(dlg, "Username is required.");
                    return;
                }
    ...
    private void resetPassword() {
        ...
        if (idVal == null) {
            UIHelper.showInfo(this, "Please select a user first.");
            return;
        }
        ...
        try {
            ...
            UIHelper.showError(this, "Operation Failed: " + ex.getMessage());
        }
    }
